...
export function WhatsAppFloat() {
  return (
    <a
      ...
      aria-label="Chat with KK Hospital on WhatsApp"
      className="fixed bottom-6 right-6 z-30 hidden h-14 w-14 place-items-center rounded-full bg-[#1f8f4e] text-white shadow-lg shadow-radiograph/25 transition-transform hover:scale-105 md:grid"
    >
